  ...
  export default {
    ...
    methods: {
      createDeliveryPDF() {
        ...
        var splitAdd = doc.splitTextToSize(this.rowInfo.deliveryAddress, 150);       
        var orderTo =	"Customer Name: " + this.rowInfo.customerName + "\n" 

        var delivStr;                

        var deliveryStuff =	"Delivery Needed: " + this.rowInfo.deliveryNeeded + "\n" +
                            this.rowInfo.dispatchDate + "\n"
        doc.setFontSize(20);
        doc.text("Delivery Note", 240, 20);
        doc.setFontSize(10);
        ...
        doc.setFontStyle("bold");
        if(this.rowInfo.deliveryAddress != null) {
          var splitDelivAdd = doc.splitTextToSize(this.rowInfo.deliveryAddress, 200); 
